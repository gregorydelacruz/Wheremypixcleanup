...
const demoVideos = [
  {
    ...
    src: "/WMP.promo.laser.eyes9.mp4", // Replace with your real demo video location or use an available file from public
...
const Demos = () => {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#090e28] via-[#232b61] to-[#2e184a]">
      <SEO
        title="Demo Videos - WhereMyPix"
        description="Watch step-by-step demos of our photo organizer and batch upload features."
        keywords={["demo videos", "how to", "photo organizer", "batch upload"]}
        ogImage="/demo.png"
        canonicalUrl="https://stripe-price-magic-58.lovable.app/demos"
      />
